...
const UserInfoMyPage = () => {
    ...
    return (
        <div className="w-full flex sm:justify-center gap-3 select-none lg:flex-row flex-col px-4">
            <div>
                <div className="bg-gray-800 text-white lg:w-[340px] w-full h-fit mt-5 relative">
