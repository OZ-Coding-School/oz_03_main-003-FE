        ...
        <div>
            <div className="relative left-[50%]">
                ...
                <motion.img
                    ...
                    className="absolute -left-[470px] top-[80px] z-10 animate-gravity"
                ...
                <motion.img
                    ...
                    animate={isInView ? { opacity: 1 } : { opacity: 0 }}
                    transition={{ duration: 1, delay: 2, type: "tween" }}
                    className="absolute -left-[570px] top-[20px] animate-gravity"
                    src="../src/assets/images/landing-forest01.svg"
                />
                <motion.img
                    initial={{ opacity: 0 }}
                    animate={isInView ? { opacity: 1 } : { opacity: 0 }}
                    transition={{ duration: 1, delay: 2, type: "tween" }}
                    className="absolute -left-[470px] -top-[20px] animate-gravity"
                    src="../src/assets/images/landing-forest01.svg"
                />
            </div>
            <div className="relative -top-[250px] left-[50%]">
                ...
                <motion.img
                    ...
                    animate={isInView ? { opacity: 1 } : { opacity: 0 }}
                    transition={{ duration: 1, delay: 2, type: "tween" }}
                    className="absolute left-[2px] -top-[65px] animate-gravity"
            ...
            <div className="relative -right-[50%] bottom-[260px]">
                ...
                <motion.img
                    ...
                    animate={isInView ? { opacity: 1 } : { opacity: 0 }}
                    transition={{ duration: 1, delay: 2, type: "tween" }}
                    className="absolute left-[90px] -top-[45px] animate-gravity"
