...
const HomeTeamInfo = () => {
    return (
        <div>
            <div className="text-white flex text-center m-auto break-keep max-w-[1200px]">
                <dl className="w-60 relative">
                    <dt>
                    ...
                    <img src="/img/landing_gradientLine.png" className="top-0 absolute right-0" />
                </dl>
                <dl className="w-60 relative">
                    <dt>
